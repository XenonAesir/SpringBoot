...
public class MaterialController
{
    ...
    @ApiImplicitParam(name = "material", value = "Material对象，包含有一个Supplier对象", paramType = "body", required = true, dataType = "Material")
    @GetMapping("/search")
    ...
    @ApiImplicitParam(name = "material", value = "Material对象，包含有一个Supplier对象，不能有material.supplier.supplierId", paramType = "body", required = true, dataType = "Material")
    @PostMapping("/save")
    ...
    @ApiImplicitParam(name = "material", value = "Material对象，包含有一个Supplier对象，必须有material.supplier.supplierId", paramType = "body", required = true, dataType = "Material")
    @PutMapping("/update")
